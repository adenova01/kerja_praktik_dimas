...
<html class="no-js h-100" lang="en">
  ...
  <body class="h-100">
    <div class="container-fluid">
      <div class="row">
        <main class="main-content col-lg-12 col-md-9 col-sm-12 p-0 align-center">
            <div class="main-navbar sticky-top bg-white">
            </div>    
            <div class="main-content-container container-fluid px-4">
                <div class="page-header row no-gutters py-4">
                    <div class="col-12 col-sm-12 text-center text-sm-left mb-0">
                        <span class="text-uppercase page-subtitle">List Berita</span>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <th><a href="{{ $item->link_berita }}" target="_blank">{{ $item->link_berita }}</a></th>
                                                <th><span class="badge badge-{{ $item->status == 'valid' ? 'success' : ( $item->status == 'hoax' ? 'danger' : 'info' ) }}">{{$item->status}}</span></th>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
